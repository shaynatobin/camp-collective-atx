      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <input
              ...
              className="px-3 py-2.5 rounded-lg border border-gray-300 text-sm text-brand-navy placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
            />
            <select
              value={category}
              onChange={(e) => setCategory(e.target.value)}
              className="px-3 py-2.5 rounded-lg border border-gray-300 text-sm text-brand-navy bg-white focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
            >
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-sm text-gray-600">
            Showing <span className="font-semibold text-brand-navy">{filtered.length}</span> of {camps.length} camps
          </p>
          {hasFilters && (
            <button
        ...
        {filtered.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="font-display text-xl font-semibold text-brand-navy mb-2">No camps found</h3>
            <p className="text-gray-500 mb-6">Try adjusting your filters or search terms.</p>
            <button
              onClick={clearFilters}
              className="px-6 py-2.5 bg-brand-terracotta text-white rounded-lg text-sm font-medium hover:bg-opacity-90"
            >
              Clear all filters
            </button>
          </div>
