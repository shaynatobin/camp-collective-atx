...
function parseRecord(record) {
  ...
  const photo = Array.isArray(photoField) && photoField.length > 0 ? photoField[0].url : (f['Logo URL'] || null)
  ...
  return {
    ...
    address: f['Address'] || '',
    photo,
    financialAid: f['Financial Aid Available'] || false,
    mealsIncluded: f['Meals Included'] || false,
    transportationProvided: f['Transportation Provided'] || false,
    aftercareAvailable: f['Aftercare Available'] || false,
  }
}
